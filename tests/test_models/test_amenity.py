...
class TestAmenity(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        """
        cls.setup = inspect.getmembers(Amenity, predicate=inspect.ismethod)

    def test_pep8_base(self):
        """to test if file: amenity.py comform to PEP8
        """
    ...
    def test_pep8_test_base(self):
        """ to test if file: test_amenity.py comform to PEP8
        """
        pep8style = pycodestyle.StyleGuide(quiet=True)
